...
//  * containing: forward_m_s strafe_m_s omega_rad_s alliance e.g. "1.0 0.0 0.0 blue" to drive
// forward
...
//  *
//  * <p>Assumptions made (tunable): - Field hubs are at ±8 meters along the X axis (blue at +8, red
// at
...
//         x + offX,
//         y + offY,
//         FieldConstants.TURRET_HEIGHT.in(Meters),
//         turretRot3);
...
//       publishNetworkTables(robotPose3d, turretPose3d, relX, relY, relDist, relAngleRobot,
// estVel);
...
//         String.format(
//             Locale.ROOT,
//             "t=%.3f\nrobot=%s\nturret=%s\nrelative_to_hub: dx=%.3f dy=%.3f dist=%.3f
// relAngleRobot=%.3f\nestimated_target_vel: vx=%.3f
// vy=%.3f\nposeEstimator=%s\nrangeEstimator=%.3f\n\n",
//             t,
//             robotPose.toString(),
//             turretPose.toString(),
