...
public final class AutoConstants {
  ...
  public static final LinearAcceleration translationMaxAcceleratMpsSq = MetersPerSecondPerSecond.of(15);
  public static final AngularVelocity maxAngularVelocityRadPerSec = DegreesPerSecond.of(240);
  public static final AngularAcceleration maxAngularAcceleratRadPerSecSq = DegreesPerSecondPerSecond.of(480);
...
public final TunableNumber autoMaxAccelTN =
    new TunableNumber("autoMaxAccelMpsSq", translationMaxAcceleratMpsSq.in(MetersPerSecondPerSecond));
...
public final TunableNumber autoMaxAngularAccelTN =
    new TunableNumber("autoMaxAngularAccelRpsSq", maxAngularAcceleratRadPerSecSq.in(RadiansPerSecondPerSecond));
