...
public final class AutoConfig {
    ...
    // -----------------------------
    public static final TunableNumber translationKP =
        new TunableNumber("auto/translation_kP", 2.25);

    public static final TunableNumber translationKI =
        new TunableNumber("auto/translation_kI", 0.05);

    public static final TunableNumber translationKD =
        new TunableNumber("auto/translation_kD", 0.0);


    // -----------------------------
    // ANGULAR PID (raw doubles)
    // -----------------------------
    public static final TunableNumber angularKP =
        new TunableNumber("auto/angular_kP", 0.45);

    public static final TunableNumber angularKI =
        new TunableNumber("auto/angular_kI", 0.0);

    public static final TunableNumber angularKIzone =
        new TunableNumber("auto/angular_kIzone", 0.05);

    public static final TunableNumber angularKD =
        new TunableNumber("auto/angular_kD", 0.05);
